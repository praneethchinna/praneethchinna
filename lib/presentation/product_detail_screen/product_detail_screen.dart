import 'package:praneeth_s_application2/widgets/app_bar/custom_app_bar.dart';
import 'package:praneeth_s_application2/widgets/app_bar/appbar_leading_image.dart';
import 'package:praneeth_s_application2/widgets/app_bar/appbar_subtitle.dart';
import 'package:praneeth_s_application2/widgets/app_bar/appbar_trailing_image.dart';
import 'package:carousel_slider/carousel_slider.dart';
import 'widgets/widget_item_widget.dart';
import 'models/widget_item_model.dart';
import 'models/product_detail_model.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';
import 'package:praneeth_s_application2/widgets/custom_rating_bar.dart';
...
import 'package:praneeth_s_application2/widgets/custom_elevated_button.dart';
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      BlocBuilder<ProductDetailBloc, ProductDetailState>(
        ...
        return CarouselSlider.builder(
            ...
            itemCount: state.productDetailModelObj?.widgetItemList.length ?? 0,
            itemBuilder: (context, index, realIndex) {
              WidgetItemModel model =
                  state.productDetailModelObj?.widgetItemList[index] ??
                      WidgetItemModel();
          ...
          child: BlocBuilder<ProductDetailBloc, ProductDetailState>(
            ...
            return SizedBox(
                ...
                child: AnimatedSmoothIndicator(
                    ...
                    count:
                        state.productDetailModelObj?.widgetItemList.length ?? 0,
            ...
            child: BlocSelector<ProductDetailBloc, ProductDetailState,
                ...
                builder: (context, productDetailModelObj) {
                  return ListView.separated(
                      ...
                      itemCount:
                          productDetailModelObj?.sizesItemList.length ?? 0,
            ...
            child: BlocSelector<ProductDetailBloc, ProductDetailState,
                ...
                builder: (context, productDetailModelObj) {
                  return ListView.separated(
                      ...
                      itemCount:
                          productDetailModelObj?.bluelistItemList.length ?? 0,
                      itemBuilder: (context, index) {
                        BluelistItemModel model =
                            productDetailModelObj?.bluelistItemList[index] ??
                                BluelistItemModel();
                        return BluelistItemWidget(model);
                      });
                })));
  }
        ...
        child: Padding(
            ...
            child:
              ...
              _buildStyle(context,
                  ...
                  styleCodeText: "lbl_cd0113_400".tr),
        ...
        child: Padding(
            ...
            child:
              ...
              _buildStyle(context,
                  ...
                  styleCodeText: "lbl_see_more".tr, onTapStyleCodeText: () {
                      ...
                      builder: (context, productDetailModelObj) {
                        return ListView.separated(
                            ...
                            itemCount: productDetailModelObj
                                    ?.products1ItemList.length ??
                                0,
                            itemBuilder: (context, index) {
                              Products1ItemModel model = productDetailModelObj
                                      ?.products1ItemList[index] ??
                                  Products1ItemModel();
        ...
        child: BlocSelector<ProductDetailBloc, ProductDetailState,
            ...
            builder: (context, productDetailModelObj) {
              return ListView.separated(
                  ...
                  itemCount:
                      productDetailModelObj?.recommendedItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    RecommendedItemModel model =
                        productDetailModelObj?.recommendedItemList[index] ??
