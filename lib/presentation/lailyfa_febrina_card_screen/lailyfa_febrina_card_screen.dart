...
import 'package:praneeth_s_application2/widgets/custom_text_form_field.dart';
                ...
                Padding(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4.v),
                          Text("lbl_lailyfa_febrina".tr,
                              style: CustomTextStyles
                                  .labelMediumOnPrimaryContainer)
                        ])),
                Padding(
                    padding: EdgeInsets.only(left: 27.h, bottom: 3.v),
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Opacity(
  ...
  Widget _buildCardNumber(BuildContext context) {
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
              padding: EdgeInsets.only(left: 2.h),
              child: BlocSelector<LailyfaFebrinaCardBloc,
